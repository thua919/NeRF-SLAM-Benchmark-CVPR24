...
from src.datasets.dataset_utils import get_camera_rays, alphanum_key, as_intrinsics_matrix
...
class BaseDataset(Dataset):
    def __init__(self, cfg):
        ...
        self.num_rays_to_save = int(self.total_pixels * cfg['mapping']['percent_pixels_save'])
        if cfg['rebut']['keyframe']:
            self.num_rays_to_save = int(self.total_pixels * 0.005) # down 10 times
